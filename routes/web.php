...
Route::group(['prefix' => 'admin', 'middleware' => 'auth'], function () {
    ...
    Route::group(['as' => 'gallery.', 'prefix' => 'gallery'], function () {
        ...
        Route::get('{id}/edit', 'Backend\GalleryController@edit')->name('edit');
...
Route::get('menu', 'Frontend\FrontendController@menu')->name('menu');
...
Route::post('booking', 'Frontend\FrontendController@bookingDetails')->name('booking-details');
Route::get('book-a-table', 'Frontend\FrontendController@book')->name('book');
Route::get('teams', 'Frontend\FrontendController@teams')->name('teams');
Route::get('blogs', 'Frontend\FrontendController@blog')->name('blog');
Route::get('blogsdetail/{blogs}', 'Frontend\FrontendController@blogDetail')->name('blogs.detail');
